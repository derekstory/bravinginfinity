...
<h1 align="center" style="background:#000;color:#fff;margin-top:70px;;width:100%;height:50px;padding-top:20px">Most Popular: All Time</h1>
...
$("#content").load("popularalltime_loadmore.php");
$("#loadmore").live("click", function(){
var next = page+=1;

$.get("popularalltime_loadmore.php?page="+next, function(data){
if(next==pages){
$("#loadmore").remove();
}
$("#content").append(data);
